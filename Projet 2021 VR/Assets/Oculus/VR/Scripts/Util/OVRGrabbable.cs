...
public class OVRGrabbable : MonoBehaviour
{
    ...
    public Vector3 m_RealOffsetPosition;
    public Vector3 m_RealOffsetRotation;
    [SerializeField]
    ...
    public Transform snapOffset
    {
        get
        {
            ...
            m_snapOffset.transform.position = m_RealOffsetPosition;
            m_snapOffset.transform.rotation = Quaternion.Euler(m_RealOffsetRotation);
